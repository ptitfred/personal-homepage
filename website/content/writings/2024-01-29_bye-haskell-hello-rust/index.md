...
I've been curious of [Haskell] since 2014, looking for a type-safe and abstract language after a few years of [Ruby] at [Captitaine Train]. It was a bit of a challenge at first, the learning curve is very steap and that's something very well documented. But once it clicked, it was a breaze.
...
If you look for haskell positions, you will most likely find a few things in British banks, some industries not hiring very actively, and the rest and majority: Blockchain centered projects.
...
The market was dry and I was to start something in Haskell it had to be on my terms in a project where I got enough influence and that I joined so early than previous technical decisions couldn't refrain me from using it.
...
- projects where I could be at the root decision wasn't thinking of me, mainly because I wasn't in the right circles. Note also that such projects are not paying your rent or you expenses unfortunately.

This reality stands in 2024 I'm afraid.
...
This was a reality I wasn't fully ready to face in 2023, and it took me the whole year to grasp it.

## A Christmas Story

Around Christmas 2023, I was a bit bored and took some time to read [the Rust Programming Language book](https://doc.rust-lang.org/book/). Don't worry, I was aware of Rust since 2014 as [Tristram], a colleague of mine at [Capitaine Train], used it for a route finder engine, and as [Clément], a as-of-then future colleague of mine, talked about it at ScalaIO 2015.

[Tristram]: https://mamot.fr/@tristramg
[Clément]: https://framapiaf.org/@clementd

I took [some notes on Mastodon of my first steps](https://pouet.chapril.org/@ptitfred/111691245597831310). Some key takeaways:
...
As a bonus Rust is very well equipped to hack embedded systems (Raspberry, Arduino, and alike) and that's very appealing. I don't see myself being involved with it professionnaly, but it will be a nice pet project later this year for sure!

## Bye Haskell?

Well, not really I guess. I will miss servant for instance, and Purescript for the web. If I was given the opportunity to use it again I will for sure.

I'm still an Haskell for hire :heart:
